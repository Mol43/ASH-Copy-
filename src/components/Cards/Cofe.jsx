import { useStore3 } from '@/context/AddToCard';
...
function Cofe2() {
  ...
  const {card, count, totalPrice, addToCart, inc, dec, updateTotalPrice } = useStore3();
  ...
  return (
    <>
      <div className="border w-[234px] h-[450px] rounded-lg p-4 bg-white shadow-lg font-sans relative">
        ...
        <img src="./cofe2.png" alt="Cappuccino" className="w-full h-auto rounded-md mb-11" />
